...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwmS6j-ZJDrNEJy7Cmya7zovBzgXNJ63m4fNhA0leWOigmqe1fslbPQJbtsIvjt23R5/exec'; // 👈 Paste your Web App URL here
    ...
    contactForm.addEventListener('submit', function (e) {
        ...
        .then(response => {
            // Because of no-cors mode, we can't read the response directly.
            // We assume success and handle errors if they were to occur on the server side.
            formStatus.textContent = "Thank you! Your enquiry has been sent.";
            formStatus.style.color = '#39b54a'; // Green color for success
            contactForm.reset();
        })
        .catch(error => {
            console.error('Error!', error.message);
            formStatus.textContent = 'Oops! Something went wrong. Please try again.';
            formStatus.style.color = '#f44336'; // Red color for error
        })
        .finally(() => {
